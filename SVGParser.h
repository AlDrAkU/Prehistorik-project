...
{
public:
	static bool GetVerticesFromSvgFile(const std::string& filePath, std::vector<Point2f>& vertices);
...
private:
	...
	static bool GetVerticesFromSvgString(std::string& svgText, std::vector<Point2f> &vertices);
	static bool GetVerticesFromPathData( const std::string& pathData, std::vector<Point2f> &vertices );
	static bool GetElementContent( const std::string& svgText, const std::string& elementName, std::string& elementValue );
